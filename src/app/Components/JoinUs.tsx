...
const JoinUs = () => {
    return ( 
        <>
            <div className="zoro flex flex-col items-center justify-center overflow-hidden gap-6 py-8 px-6 h-full  sm:h-[350px] w-full sm:w-[800px] mb-10 border border-[#1F212E] rounded-xl">
  ...
  <div className="flex overflow-hidden rounded-2xl border p-1.5 border-[#191A24] bg-[#09090B] focus-within:border-[#818CF8] focus-within:shadow-[inset_0_2px_8px_rgba(129,140,248,0.3)] transition-all duration-200">
    ...
    />
    <button className="px-4 py-2 text-sm sm:text-md -ml-12 sm:-ml-0 bg-[#0B0B0E] rounded-xl shadow-[inset_0_2px_8px_rgba(129,140,248,0.3)] text-white hover:bg-[#1A1A24] transition">
      Search
    </button>
  </div>
</div>
